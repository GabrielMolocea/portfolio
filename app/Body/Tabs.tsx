...
export default function Tabs({ isDarkMode }: { isDarkMode: boolean }) {
    ...
    return (
        <>
            <div className='rounded-xl bg-white p-3 ring-white ring-opacity-60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2 sticky top-0'>
            ...
            <div className='w-full max-w-md px-2 py-16 sm:px-0 ml-0 lg:ml-4 drop-shadow-lg flex'>
